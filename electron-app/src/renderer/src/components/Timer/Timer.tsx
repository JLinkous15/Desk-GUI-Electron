...
export const Timer = () => {
  ...
  const handleTimerSelect = (event: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
  ...
  return (
    <Stack direction="column" alignItems="center" spacing={4} maxWidth={'700px'}>
      ...
      <TimerKnob timer={newTimer} setTimerDrag={setTimerDrag} handleButton={handleButton} />
